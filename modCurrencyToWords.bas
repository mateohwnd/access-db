Attribute VB_Name = "modCurrencyToWords"
...
' Clean up Centavos.
         ...
         If Pesos = "" Then
         ConvertCurrencyToEnglish = Centavos & " Only"
         ElseIf Centavos = "" Then
         ConvertCurrencyToEnglish = Pesos & " Only"
         Else
         ConvertCurrencyToEnglish = Pesos & " and " & Centavos & " Only"
         End If
